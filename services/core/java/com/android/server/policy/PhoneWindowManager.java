...
//                    break;
    ...
    class SettingsObserver extends ContentObserver {
	    ...
	    resolver.registerContentObserver(Settings.System.getUriFor(
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.ANSWER_HOME_BUTTON_BEHAVIOR_ANSWER), false, this,
                    UserHandle.USER_ALL);
	    resolver.registerContentObserver(Settings.System.getUriFor(
	    ...
	    resolver.registerContentObserver(Settings.System.getUriFor(
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.OMNI_BOTTOM_GESTURE_FEEDBACK_DURATION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
    ...
    public void updateSettings() {
	    ...
	    mProxiWakeupCheckEnabled = Settings.System.getIntForUser(resolver,
            ...
            mHomeAnswer = (Settings.System.getIntForUser(resolver,
                    Settings.System.ANSWER_HOME_BUTTON_BEHAVIOR_ANSWER, 0,
                    UserHandle.USER_CURRENT) == 1);
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
		...
		if (mProxiListenerEnabled && mProxyIsNear) {
                    if (DEBUG_PROXI_SENSOR) Log.i(TAG, "KeyEvent.KEYCODE_HOME blocked because of mProxyIsNear");
                    break;
                }
	        if (down && !interactive) {
                    isWakeKey = true;
