        ...
        for (int i = 0; i < origSize; i++) {
            ...
            if (tunIfaceTotal.rxBytes > 0) {
                ...
                final long rxBytesAcrossUnderlyingIfaces =
                        multiplySafe(underlyingIfacesTotal.rxBytes,
            ...
            if (tunIfaceTotal.rxPackets > 0) {
                final long rxPacketsAcrossUnderlyingIfaces =
                        multiplySafe(underlyingIfacesTotal.rxPackets,
            ...
            if (tunIfaceTotal.txBytes > 0) {
                final long txBytesAcrossUnderlyingIfaces =
                        multiplySafe(underlyingIfacesTotal.txBytes,
            ...
            if (tunIfaceTotal.txPackets > 0) {
                final long txPacketsAcrossUnderlyingIfaces =
                        multiplySafe(underlyingIfacesTotal.txPackets,
            ...
            if (tunIfaceTotal.operations > 0) {
                final long operationsAcrossUnderlyingIfaces =
                        multiplySafe(underlyingIfacesTotal.operations,
