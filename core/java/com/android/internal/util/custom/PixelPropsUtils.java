...
public class PixelPropsUtils {
    ...
    private static final Map<String, Object> propsToChangeSONY;
    ...
    static {
        ...
        propsToChangeSONY = new HashMap<>();
        propsToChangeSONY.put("MODEL", "SO-52A");
        propsToChangeSONY.put("MANUFACTURER", "SONY");
    }
    ...
    public static void setProps(String packageName) {
        ...
        if (Arrays.asList(propsToChangeSONY).contains(packageName)){
            if (DEBUG){
                Log.d(TAG, "Defining props for: " + packageName);
            }
            for (Map.Entry<String, Object> prop : propsToChangeOP8P.entrySet()) {
