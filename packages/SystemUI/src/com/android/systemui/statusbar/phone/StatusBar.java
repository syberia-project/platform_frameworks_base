...
public class StatusBar extends SystemUI implements DemoMode,
            ...
            if (uri.equals(Settings.System.getUriFor(
                ...
                updateChargingAnimation();
                 ...
                 if (!ActionUtils.hasNavbarByDefault(mContext)) {
                    ...
                    Settings.Secure.PIE_STATE)) ||
                    uri.equals(Settings.Secure.getUriFor(Settings.Secure.PIE_GRAVITY))) {
    ...
    protected void makeStatusBarView() {
        ...
        filter.addAction(SyberiaUtils.ACTION_DISMISS_KEYGUARD);
    ...
    public boolean isUsingSyberiaTheme() {
        return ThemeAccentUtils.isUsingSyberiaTheme(mOverlayManager, mLockscreenUserManager.getCurrentUserId());
    }
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            else if (SyberiaUtils.ACTION_DISMISS_KEYGUARD.equals(action)) {
                if (intent.hasExtra(SyberiaUtils.DISMISS_KEYGUARD_EXTRA_INTENT)) {
                    Intent launchIntent = (Intent) intent.getParcelableExtra(SyberiaUtils.DISMISS_KEYGUARD_EXTRA_INTENT);
    ...
    protected void updateTheme() {
        ...
        if (isUsingSyberiaTheme() != useSyberiaTheme) {
            ...
            unfuckBlackWhiteAccent();
            unloadAccents();
            ThemeAccentUtils.setLightSyberiaTheme(mOverlayManager, mLockscreenUserManager.getCurrentUserId(), useSyberiaTheme);
            mNotificationPanel.setLockscreenClockTheme(useSyberiaTheme);
        }
    ...
    private void updateGamingPeekMode() {
        mGamingModeActivated = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.GAMING_MODE_ACTIVE, 1, UserHandle.USER_CURRENT) == 1;
        mHeadsUpDisabled = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.GAMING_MODE_HEADSUP_TOGGLE, 1, UserHandle.USER_CURRENT) == 1;
