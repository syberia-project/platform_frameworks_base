package com.syberia.android.systemui.keyguard;
...
public class SyberiaKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        AddShadowTask(SyberiaKeyguardSliceProvider keyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
        ...
        public void onPostExecute(Bitmap bitmap) {
            SyberiaKeyguardSliceProvider keyguardSliceProvider;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProvider = (SyberiaKeyguardSliceProvider) mProviderReference.get();
            }
