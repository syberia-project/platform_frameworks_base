...
public abstract class SyberiaSystemUIModule {
    ...
    @Provides
    @SysUISingleton
    static SyberiaServices provideSyberiaServices(Context context, UiEventLogger uiEventLogger, Lazy<ColumbusServiceWrapper> lazyB) {
        return new SyberiaServices(context, uiEventLogger, lazyB);
    }
